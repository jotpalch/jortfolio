...
export default function AboutPage() {
  return (
    <>
      {/* Desktop: Terminal */}
      <section className="hidden min-h-screen items-center px-4 py-12 md:flex sm:py-20">
        <Terminal />
      </section>

      {/* Mobile: Original about */}
          ...
          <section className="py-12 sm:py-20">
            <Container>
              ...
              <div className="grid gap-8 sm:gap-12 lg:grid-cols-2">
                <AnimatedSection>
                  <div className="space-y-5 text-base leading-relaxed text-muted-brown">
                    ...
                    <p>
                      My work spans Linux driver development, agentic AI, and systems engineering.
                      ...
                      <strong className="text-charcoal dark:text-cream">Realtek</strong>.
                    </p>
                    <p>
                      Outside of code, I shoot <strong className="text-charcoal dark:text-cream">negative film</strong> and
                      a <strong className="text-charcoal dark:text-cream">Ricoh GR3x HDF</strong>.
                    </p>
                  </div>
                </AnimatedSection>
              ...
              <div className="mt-16 sm:mt-24">
                <AnimatedSection>
                  <div className="mb-12">
                    <p className="font-mono text-xs uppercase tracking-widest text-muted-brown">Professional path</p>
                    <h2 className="mt-2 font-serif text-3xl font-bold italic text-charcoal dark:text-cream">Work Experience</h2>
                    <div className="mt-3 h-0.5 w-12 bg-terracotta" />
                  </div>
                </AnimatedSection>
                <ExperienceTimeline />
              ...
              <div className="mt-16 sm:mt-24">
                <AnimatedSection>
                  <div className="mb-12">
                    <p className="font-mono text-xs uppercase tracking-widest text-muted-brown">Academic journey</p>
                    <h2 className="mt-2 font-serif text-3xl font-bold italic text-charcoal dark:text-cream">Education</h2>
                    <div className="mt-3 h-0.5 w-12 bg-terracotta" />
                  </div>
                </AnimatedSection>
                <EducationTimeline />
